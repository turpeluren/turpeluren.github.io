(function () {
	...
	const user = 'user@turpelurpeluren.online:~$ ';
	...
	function matchCommand(val) {
		...
		case 'goto':
			var tryPath = 'turpelurpeluren.online/' + args[1];
			printLine('trying to access: turpelurpeluren.online/' + args[1] + ' ...\n');
			window.location = tryPath;
			break;

		case 'help':
			printLine('help\t\t\t- displays a list of commands\n'+
		...
		default:
			printLine('-turpelurpeluren: ' + val + ': command not found\n');
		}
	}
